...
<body>
    ...
    <form id="produtoForm" action="produto_update.php" method="post">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>
                             ...
                             <td colspan='1'><input class='form-control' type='text' id='descricao' name='descricao' maxlength='150' value=" . $row['Descricao'] . "></td>
                          </tr>
                          <tr>
                             <td><label for='valor'>Preço:</label></td>
                             <td><input type='number' class='form-control' name='valor' id='valor' value=" . $row['Preco'] . "></td>
                          </tr>
                          <tr>
                             <td colspan='1'><label for='unidade'>Unidade:</label></td>
                             <td colspan='1'><input class='form-control' type='text' id='unidade' name='unidade' maxlength='2' value=" . $row['Unidade'] . "></td>
                          </tr>
                          <tr>
                             <td><label for='quantidade_minima'>Quantidade Mínima:</label></td>
                             <td><input class='form-control' type='number' id='quantidade_minima' name='quantidade_minima' step='0.01' value=" . $row['Quantidade_Minima'] . "></td>
                          </tr>
                          <tr>
                             <td><label for='quantidade_atual'>Quantidade Atual:</label></td>
                             <td><input class='form-control' type='number' id='quantidade_atual' name='quantidade_atual' step='0.01' value=" . $row['Quantidade_Atual'] . "></td>
                          </tr>";
                    }
                }
                ?>
