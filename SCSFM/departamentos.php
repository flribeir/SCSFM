...
<body>
        ...
        <div class="grid">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    // Consulta SQL para selecionar todos os Departamentos
    ...
    <div class="bottom">
        <div class="buttons">
            <button class="btn btn-primary" onclick="openModal('incluir_departamento.php')">Incluir</button>
